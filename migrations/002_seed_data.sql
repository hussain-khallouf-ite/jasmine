...
('عمارة الياسمين D', 'عمارة سكنية حديثة بتصميم اقتصادي وعملي تناسب الشباب والعائلات الصغيرة.', 6, 'https://images.unsplash.com/photo-1460317442991-0ec209397118?auto=format&fit=crop&w=900&q=80', 'وادي الجوز - الحي الغربي', 4500.00),
('مول الياسمين التجاري', 'مركز تسوق متكامل يحتوي على محلات تجارية ومطاعم ومناطق ترفيهية.', 4, 'https://images.unsplash.com/photo-1519999482648-25049ddd37b1?auto=format&fit=crop&w=900&q=80', 'وادي الجوز - المدخل الرئيسي', 15000.00);
...
(2, 'استوديو عصري مفروش', 'استوديو أنيق مفروش بالكامل مثالي للطلاب أو الموظفين.', 'وادي الجوز - حي الأكاديميين', 'https://images.unsplash.com/photo-1536376074432-ad427499eaa8?auto=format&fit=crop&w=900&q=80', 'residential', 1, 45.0, 1, 150.00, 'rent', 'reserved', '["wifi", "parking"]'),
...
(1, 'شقة بغرفة نوم واحدة', 'مثالية للعرسان والموظفين', 'وادي الجوز', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=900&q=80', 'residential', 1, 60.0, 3, 180.00, 'rent', 'available', '["elevator"]'),
(1, 'مكتب إداري متوسط', 'إطلالة بانورامية', 'وادي الجوز - منطقة الأبراج التجارية', 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=900&q=80', 'commercial', 3, 85.0, 4, 800.00, 'rent', 'available', '["elevator", "security"]'),
(4, 'شقة 2 غرف مريحة', 'شقة بتصميم جميل وإضاءة طبيعية', 'وادي الجوز - الحي الغربي', 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=900&q=80', 'residential', 2, 85.0, 1, 200.00, 'rent', 'available', '["parking"]'),
(4, 'استوديو اقتصادي', 'مناسب لسكن الطلاب', 'وادي الجوز - الحي الغربي', 'https://images.unsplash.com/photo-1501183638710-841dd1904471?auto=format&fit=crop&w=900&q=80', 'residential', 1, 40.0, 2, 120.00, 'rent', 'available', '["wifi"]'),
(5, 'محل واجهة رئيسية', 'مساحة ممتازة للمطاعم', 'وادي الجوز - المدخل الرئيسي', 'https://images.unsplash.com/photo-1555529771-835f59fc5efe?auto=format&fit=crop&w=900&q=80', 'commercial', 1, 100.0, 0, 2000.00, 'rent', 'reserved', '["security", "frontage"]'),
(5, 'كشك داخل المول', 'مثالي للإكسسوارات والعطور', 'وادي الجوز - المدخل الرئيسي', 'https://images.unsplash.com/photo-1534452203293-494d7ddbf7e0?auto=format&fit=crop&w=900&q=80', 'commercial', 1, 15.0, 1, 500.00, 'rent', 'available', '["security", "wifi"]'),
...
(1, 'محل تجاري للبيع', 'محل بموقع استراتيجي على الشارع الرئيسي.', 'وادي الجوز - شارع المعارض الرئيسي', 'https://images.unsplash.com/photo-1555529771-835f59fc5efe?auto=format&fit=crop&w=900&q=80', 'commercial', 2, 60.0, 0, 50000.00, 'sale', 'unavailable', '["security", "frontage"]'),
(3, 'فيلا دوبلكس', 'تصميم عصري بمدخل خاص', 'وادي الجوز - حي الياسمين الشرقي', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=900&q=80', 'residential', 6, 320.0, 1, 120000.00, 'sale', 'available', '["parking", "garden", "smart home"]'),
(4, 'شقة استثمارية 3 غرف', 'فرصة استثمارية واعدة', 'وادي الجوز - الحي الغربي', 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=900&q=80', 'residential', 3, 110.0, 4, 45000.00, 'sale', 'available', '["elevator", "balcony"]'),
(5, 'مساحة مكاتب واسعة', 'طابق كامل في المول التجاري للشركات الكبرى', 'وادي الجوز - المدخل الرئيسي', 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=900&q=80', 'commercial', 8, 400.0, 3, 250000.00, 'sale', 'available', '["security", "elevator", "parking"]');
