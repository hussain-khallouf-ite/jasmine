...
-- Rent Properties
('شقة فاخرة 3 غرف نوم مع إطلالة على الوادي', 'شقة واسعة مع إطلالات خلابة على وادي الجوز. تشطيب عصري.', 'وادي الجوز - قطاع أ (إطلالة الوادي)', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=900&q=80', 'residential', 3, 140.5, 4, 350.00, 'rent', 'available', '["parking", "elevator", "generator", "balcony"]'),
('شقة مريحة 2 غرف نوم في الوسط', 'وحدة عائلية مريحة تقع بالقرب من بوابة المشروع الرئيسية.', 'وادي الجوز - الحي المتوسط (السنتر)', 'https://images.unsplash.com/photo-1502672260266-1c1de2d93688?auto=format&fit=crop&w=900&q=80', 'residential', 2, 95.0, 2, 220.00, 'rent', 'available', '["parking", "elevator"]'),
('استوديو عصري مفروش', 'استوديو أنيق مفروش بالكامل مثالي للطلاب أو الموظفين.', 'وادي الجوز - حي الأكاديميين', 'https://images.unsplash.com/photo-1536376074432-ad427499eaa8?auto=format&fit=crop&w=900&q=80', 'residential', 1, 45.0, 1, 150.00, 'rent', 'available', '["wifi", "parking"]'),
('مكتب تجاري في برج الياسمين', 'مكتب واسع في منطقة حيوية، مناسب للشركات الناشئة.', 'وادي الجوز - منطقة الأبراج التجارية', 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=900&q=80', 'commercial', 4, 120.0, 5, 1200.00, 'rent', 'available', '["elevator", "security", "parking"]'),

-- Sale Properties
('بنتهاوس فاخر للبيع', 'معيشة في الطابق العلوي مع تراس خاص وتخزين ماء.', 'وادي الجوز - حي الفلل العلوي', 'https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=900&q=80', 'residential', 4, 210.0, 8, 85000.00, 'sale', 'available', '["parking", "elevator", "generator", "water storage", "smart home"]'),
('شقة عائلية كبيرة للبيع', 'شقة في منطقة هادئة مع حديقة صغيرة مشتركة.', 'وادي الجوز - حي الياسمين الشرقي', 'https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=900&q=80', 'residential', 5, 180.0, 0, 75000.00, 'sale', 'available', '["parking", "garden"]'),
('محل تجاري للبيع', 'محل بموقع استراتيجي على الشارع الرئيسي.', 'وادي الجوز - شارع المعارض الرئيسي', 'https://images.unsplash.com/photo-1555529771-835f59fc5efe?auto=format&fit=crop&w=900&q=80', 'commercial', 2, 60.0, 0, 50000.00, 'sale', 'available', '["security", "frontage"]');
